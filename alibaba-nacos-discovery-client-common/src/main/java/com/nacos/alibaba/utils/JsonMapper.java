...
public class JsonMapper extends ObjectMapper {
    ...
    public static void main(String[] args) {
    	...
    	String liststr = "[{infokey:'11',info:'1111'},{infokey:'22',info:'2222'}]";
    	
    	List jsonlist = JsonMapper.getInstance().toList(liststr, HashMap.class);
        
    	try
    	{
    		for(int i = 0 ; i < jsonlist.size() ; i++) {
    			//JsonMapper.fromJsonString(jsonString, Map);
    			Map<String, String> infomap = (HashMap<String, String>)jsonlist.get(i);
    			
    			System.out.println(infomap.get("infokey"));
    		}
